      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-4 text-sm font-medium text-gray-500">
            <span className="hover:text-green-600 cursor-pointer">Register to Vote</span>
            <span className="hover:text-green-600 cursor-pointer">Find Polling Station</span>
            <span className="text-green-600 font-bold">Constitution</span>
          </div>
        </div>
      </nav>
